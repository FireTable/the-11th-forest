 ...
 *
 * Restart reuses the cached ResolvedScene from main.ts and hands it to
 * the existing `restartSceneWith` helper — same path the editor's
 * "jump to scene" button uses. The Phaser scene is destroyed and a
 * fresh LoadScene is constructed with full HP from the spec.
 */

import { Skull } from 'lucide-react';

import { Button } from '@/components/ui/button';
import { restartSceneWith } from '@/lib/phaser-game';
import { getCachedResolvedScene } from '@/game/resolve-scene';
    ...
    return (
        ...
        >
            <div className="flex flex-col items-center gap-4 rounded border border-red-700/60 bg-neutral-900/95 px-10 py-8 font-mono text-neutral-100 shadow-2xl">
                ...
                <div className="text-2xl font-bold tracking-widest text-red-400">
                    YOU DIED
                </div>
